  ...
  return {
    ...
    render() {
      return `
        ...
        <main>
          <section id="home" class="hero">
            <div class="hero-content">
              <h2>Selamat Datang di Toko Elektronik Jaya</h2>
              <p>Toko elektronik terlengkap dengan harga terjangkau dan garansi resmi</p>
          ...
          <section id="about" class="about">
            <div class="container">
              <h2>Tentang Kami</h2>
              <p>Kami adalah Elektronik terpercaya yang melayani dengan sepenuh hati.</p>
            </div>
          </section>
          ...
          <section id="contact" class="contact">
            <div class="container">
              ...
              <div class="contact-info">
                ...
                <p>📧 Email: info@tokoelektronikjaya.com</p>
        ...
        <footer class="footer">
          <div class="container">
            <p>&copy; 2025 Toko Elektronik Jaya. Dibuat dengan ❤️ oleh NYAI</p>
          </div>
        </footer>
      `
    },
